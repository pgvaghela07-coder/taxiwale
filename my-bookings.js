...
function populateEditVehicleCityDropdown() {
  const gujaratCities = [
    "Ahmedabad",
    "Vadodara",
    "Surat",
  ...
  const citySelect = document.getElementById("editLocationCity");
  if (citySelect) {
...
async function editVehicle(vehicleId) {
  try {
    ...
    // Set trip type toggle
    const tripType = vehicleData.tripType || "one-way";
    if (tripType === "one-way") {
      document.getElementById("editVehicleOneWay").classList.add("active");
      document
        .getElementById("editVehicleRoundTrip")
        .classList.remove("active");
    } else {
      document.getElementById("editVehicleRoundTrip").classList.add("active");
      document.getElementById("editVehicleOneWay").classList.remove("active");
    }
...
async function submitVehicleEdit() {
  ...
  // Get trip type
  const tripType = document
    .getElementById("editVehicleOneWay")
    .classList.contains("active")
    ? "one-way"
    : "round-trip";
...
function closeEditVehicleModal() {
  ...
  if (modal) {
    ...
    // Reset trip type
    document.getElementById("editVehicleOneWay").classList.add("active");
    document.getElementById("editVehicleRoundTrip").classList.remove("active");
...
function toggleEditVehicleTripType(type) {
  const oneWayBtn = document.getElementById("editVehicleOneWay");
  const roundTripBtn = document.getElementById("editVehicleRoundTrip");
...
// Populate city dropdowns for edit vehicle modal
