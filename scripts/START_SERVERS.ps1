...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$PSScriptRoot'; Write-Host '🌐 Tripeaz Taxi Partners - Frontend Server' -ForegroundColor Green; Write-Host 'Starting on http://localhost:3000...' -ForegroundColor Cyan; Write-Host ''; node frontend/server.js" -WindowStyle Normal
